...
export const homeContent = {
  welcome: {
    title: "Welcome",
    description:
      "This is a Next.js template with TypeScript, Zustand state management, theme switching, and internationalization support.",
  },
  features: [
...
export const aboutContent = {
  ...
  experience: [
    ...
    },
    {
      ...
      period: "2020 - 2022",
      description:
        "Built responsive web applications using React and Next.js, collaborating with design and backend teams.",
    },
  ],
};
...
export const workContent = {
  ...
  projects: [
    ...
    },
    {
      ...
      description:
        "Real-time analytics dashboard with interactive charts and data visualization using modern web technologies.",
    ...
    },
    {
      ...
      description:
        "A responsive social media application with real-time updates, user authentication, and content management.",
...
export const contactContent = {
  title: "Get In Touch",
  subtitle: "Let's work together on next project",
  methods: [
    {
      id: "email",
      title: "Email",
      description:
        "Prefer written communication? Send me an email with project details and I will respond within three business day.",
      value: "zytbarbara@outlook.com",
      details: [
        "Best for detailed briefs and proposals",
        "Replay as soon as I see it",
      ],
    },
    {
      id: "whatsapp",
      ...
      details: [
        ...
        "Let's work together and progress",
      ],
    },
  ],
